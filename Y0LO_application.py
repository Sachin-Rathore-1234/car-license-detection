...
# Load YOLO model
try:
    model = YOLO('/Users/sachin/Downloads/car license detection project/best_license_plate_model.pt')  # Replace with the path to your trained YOLO model
...
if uploaded_file is not None:
    os.makedirs("temp", exist_ok=True)  # ✅ Create folder if missing
